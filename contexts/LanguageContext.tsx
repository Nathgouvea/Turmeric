...
const translations = {
  en: {
    ...
    // New Year's Eve Page
    "newyears.hero.year": "2026",
    "newyears.hero.title": "NEW YEAR'S EVE",
    "newyears.hero.restaurant": "Turmeric Restaurant",
    "newyears.hero.subtitle": "Exclusive Dinner Package",
    "newyears.hero.price": "49€",
    "newyears.hero.perPerson": "per person",
    "newyears.hero.includes": "Four Course + One Drink (Non-Alcoholic)",
    "newyears.btn.reserve": "Reserve Your Table",
    "newyears.btn.backToSite": "Back to Main Site",
    "newyears.menu.badge": "Exclusive Menu",
    "newyears.menu.title": "New Year's Eve Dinner",
    "newyears.menu.subtitle": "A carefully curated four-course experience featuring the finest Pakistani & Indian cuisine",
    "newyears.menu.appetizers": "APPETIZERS",
    "newyears.menu.starters": "STARTERS",
    "newyears.menu.mainCourse": "MAIN COURSE",
    "newyears.menu.sweets": "SWEETS",
    "newyears.menu.drinks": "DRINKS",
    "newyears.menu.papadum": "Papadum",
    "newyears.menu.papadumDesc": "Thin, crispy lentil wafers, perfectly spiced and served with flavorful homemade special chutneys.",
    "newyears.menu.kebab": "Turmeric Special Kebab",
    "newyears.menu.kebabDesc": "A delightful combination of tender non-vegetarian kebabs and flavorful vegetarian kebabs, perfectly grilled and served with mint chutney, tangy tamarind dip, and refreshing spiced raita.",
    "newyears.menu.curry": "One Curry of your Choice from Our Signature Collection",
    "newyears.menu.curryDesc": "Butter Chicken, Chicken Tikka Masala, Chicken Curry/Kadhai, Beef Kadhai/Curry, Beef Korma, Palak Paneer, Paneer Butter Masala, Vegetable Korma and Daal Tadka/Makhni.",
    "newyears.menu.naan": "Naan Bread of your Choice and Steam Rice",
    "newyears.menu.kheer": "Kheer",
    "newyears.menu.kheerDesc": "Creamy rice pudding with cardamom, and a sprinkle of nuts for a luxurious finish.",
    "newyears.menu.halwa": "Gajjar Halwa",
    "newyears.menu.halwaDesc": "Warm, rich carrot dessert cooked in milk, and cardamom, topped with crunchy nuts.",
    "newyears.menu.rasmalai": "Rasmalai",
    "newyears.menu.rasmalaiDesc": "Soft cream paneer soaked in saffron milk, delicately sweetened and garnished with pistachios.",
    "newyears.menu.lassi": "Homemade Special Lassi (Mango, Sweet or Salty) or Soft Drink / Water",
    "newyears.menu.completePackage": "Complete Package:",
    "newyears.gallery.title": "A Taste of What Awaits",
    "newyears.gallery.subtitle": "Experience the finest Pakistani & Indian cuisine, prepared with love and authentic spices",
    "newyears.reservation.title": "Reserve Your Table",
    "newyears.reservation.subtitle": "Secure your spot for an unforgettable New Year's Eve celebration",
    "newyears.reservation.cardTitle": "New Year's Eve Reservation",
    "newyears.reservation.cardSubtitle": "December 31st, 2025 - Celebrate with us!",
    "newyears.form.fullName": "Full Name *",
    "newyears.form.namePlaceholder": "Your name",
    "newyears.form.email": "Email *",
    "newyears.form.emailPlaceholder": "your@email.com",
    "newyears.form.phone": "Phone Number *",
    "newyears.form.phonePlaceholder": "Phone number",
    "newyears.form.guests": "Number of Guests *",
    "newyears.form.selectGuests": "Select number of guests",
    "newyears.form.guest": "guest",
    "newyears.form.guests_plural": "guests",
    "newyears.form.specialRequests": "Special Requests",
    "newyears.form.specialRequestsPlaceholder": "Any dietary requirements or special requests...",
    "newyears.form.submit": "Submit Reservation Request",
    "newyears.form.confirmNote": "We will confirm your reservation within 48 hours",
    "newyears.form.searchCountry": "Search...",
    "newyears.success.title": "Reservation Request Submitted!",
    "newyears.success.message": "Thank you for choosing Turmeric Restaurant for your New Year's Eve celebration.",
    "newyears.success.confirmNote": "We will contact you within 48 hours to confirm your reservation.",
    "newyears.success.anotherReservation": "Make Another Reservation",
    "newyears.contact.title": "Contact Us Directly",
    "newyears.contact.callUs": "Call us",
    "newyears.contact.emailUs": "Email us",
    "newyears.contact.visitUs": "Visit us",
    "newyears.eventDetails.title": "Event Details",
    "newyears.eventDetails.date": "December 31st, 2025",
    "newyears.eventDetails.courses": "Four Course Dinner",
    "newyears.eventDetails.drink": "One Non-Alcoholic Drink Included",
    "newyears.eventDetails.note": "Turmeric is an alcohol-free restaurant. We offer a variety of homemade lassis, soft drinks, and refreshing beverages.",
    "newyears.footer.copyright": "© 2025 Turmeric Restaurant. All rights reserved.",
    "newyears.footer.backToMain": "Back to Main Website",
    "newyears.banner.title": "New Year's Eve 2026 Dinner",
    "newyears.banner.courses": "4 Courses + Drink",
    "newyears.banner.reserveNow": "Reserve Now",
    "newyears.banner.book": "Book",
    "newyears.banner.dinnerPackage": "Dinner Package",
    "newyears.banner.perPerson": "per person",
    "newyears.banner.includes": "Four Course Meal + One Non-Alcoholic Drink",
    "newyears.banner.date": "Dec 31, 2025",
    "newyears.banner.fourCourses": "4 Courses",
    "newyears.banner.viewMenu": "View Menu & Reserve",
    "newyears.banner.call": "Call",
    "newyears.banner.reserve": "Reserve",
    "newyears.banner.limited": "Limited seats available. Book early!",
  },
  pt: {
    // Navigation
    "nav.home": "Início",
    ...
    // New Year's Eve Page
    "newyears.hero.year": "2026",
    "newyears.hero.title": "VÉSPERA DE ANO NOVO",
    "newyears.hero.restaurant": "Restaurante Turmeric",
    "newyears.hero.subtitle": "Pacote de Jantar Exclusivo",
    "newyears.hero.price": "49€",
    "newyears.hero.perPerson": "por pessoa",
    "newyears.hero.includes": "Quatro Pratos + Uma Bebida (Não Alcoólica)",
    "newyears.btn.reserve": "Reserve a Sua Mesa",
    "newyears.btn.backToSite": "Voltar ao Site Principal",
    "newyears.menu.badge": "Menu Exclusivo",
    "newyears.menu.title": "Jantar de Véspera de Ano Novo",
    "newyears.menu.subtitle": "Uma experiência de quatro pratos cuidadosamente selecionados com a melhor culinária paquistanesa e indiana",
    "newyears.menu.appetizers": "ENTRADAS",
    "newyears.menu.starters": "APERITIVOS",
    "newyears.menu.mainCourse": "PRATO PRINCIPAL",
    "newyears.menu.sweets": "SOBREMESAS",
    "newyears.menu.drinks": "BEBIDAS",
    "newyears.menu.papadum": "Papadum",
    "newyears.menu.papadumDesc": "Bolachas finas e crocantes de lentilha, perfeitamente temperadas e servidas com chutneys caseiros especiais.",
    "newyears.menu.kebab": "Kebab Especial Turmeric",
    "newyears.menu.kebabDesc": "Uma deliciosa combinação de kebabs tenros não vegetarianos e saborosos kebabs vegetarianos, perfeitamente grelhados e servidos com chutney de menta, molho de tamarindo e raita temperada.",
    "newyears.menu.curry": "Um Curry à Sua Escolha da Nossa Coleção Especial",
    "newyears.menu.curryDesc": "Butter Chicken, Chicken Tikka Masala, Chicken Curry/Kadhai, Beef Kadhai/Curry, Beef Korma, Palak Paneer, Paneer Butter Masala, Vegetable Korma e Daal Tadka/Makhni.",
    "newyears.menu.naan": "Pão Naan à Sua Escolha e Arroz Cozido a Vapor",
    "newyears.menu.kheer": "Kheer",
    "newyears.menu.kheerDesc": "Pudim de arroz cremoso com cardamomo e uma pitada de frutos secos para um final luxuoso.",
    "newyears.menu.halwa": "Gajjar Halwa",
    "newyears.menu.halwaDesc": "Sobremesa quente e rica de cenoura cozinhada em leite e cardamomo, coberta com frutos secos crocantes.",
    "newyears.menu.rasmalai": "Rasmalai",
    "newyears.menu.rasmalaiDesc": "Paneer cremoso macio mergulhado em leite com açafrão, delicadamente adoçado e decorado com pistácios.",
    "newyears.menu.lassi": "Lassi Especial Caseiro (Manga, Doce ou Salgado) ou Refrigerante / Água",
    "newyears.menu.completePackage": "Pacote Completo:",
    "newyears.gallery.title": "Um Sabor do Que o Espera",
    "newyears.gallery.subtitle": "Experiencie a melhor culinária paquistanesa e indiana, preparada com amor e especiarias autênticas",
    "newyears.reservation.title": "Reserve a Sua Mesa",
    "newyears.reservation.subtitle": "Garanta o seu lugar para uma celebração inesquecível de Véspera de Ano Novo",
    "newyears.reservation.cardTitle": "Reserva de Véspera de Ano Novo",
    "newyears.reservation.cardSubtitle": "31 de Dezembro de 2025 - Celebre connosco!",
    "newyears.form.fullName": "Nome Completo *",
    "newyears.form.namePlaceholder": "O seu nome",
    "newyears.form.email": "Email *",
    "newyears.form.emailPlaceholder": "o.seu@email.com",
    "newyears.form.phone": "Número de Telefone *",
    "newyears.form.phonePlaceholder": "Número de telefone",
    "newyears.form.guests": "Número de Convidados *",
    "newyears.form.selectGuests": "Selecione o número de convidados",
    "newyears.form.guest": "convidado",
    "newyears.form.guests_plural": "convidados",
    "newyears.form.specialRequests": "Pedidos Especiais",
    "newyears.form.specialRequestsPlaceholder": "Quaisquer requisitos dietéticos ou pedidos especiais...",
    "newyears.form.submit": "Enviar Pedido de Reserva",
    "newyears.form.confirmNote": "Confirmaremos a sua reserva dentro de 48 horas",
    "newyears.form.searchCountry": "Pesquisar...",
    "newyears.success.title": "Pedido de Reserva Enviado!",
    "newyears.success.message": "Obrigado por escolher o Restaurante Turmeric para a sua celebração de Véspera de Ano Novo.",
    "newyears.success.confirmNote": "Entraremos em contacto dentro de 48 horas para confirmar a sua reserva.",
    "newyears.success.anotherReservation": "Fazer Outra Reserva",
    "newyears.contact.title": "Contacte-nos Diretamente",
    "newyears.contact.callUs": "Ligue-nos",
    "newyears.contact.emailUs": "Envie-nos email",
    "newyears.contact.visitUs": "Visite-nos",
    "newyears.eventDetails.title": "Detalhes do Evento",
    "newyears.eventDetails.date": "31 de Dezembro de 2025",
    "newyears.eventDetails.courses": "Jantar de Quatro Pratos",
    "newyears.eventDetails.drink": "Uma Bebida Não Alcoólica Incluída",
    "newyears.eventDetails.note": "O Turmeric é um restaurante sem álcool. Oferecemos uma variedade de lassis caseiros, refrigerantes e bebidas refrescantes.",
    "newyears.footer.copyright": "© 2025 Restaurante Turmeric. Todos os direitos reservados.",
    "newyears.footer.backToMain": "Voltar ao Site Principal",
    "newyears.banner.title": "Jantar de Ano Novo 2026",
    "newyears.banner.courses": "4 Pratos + Bebida",
    "newyears.banner.reserveNow": "Reserve Agora",
    "newyears.banner.book": "Reservar",
    "newyears.banner.dinnerPackage": "Pacote de Jantar",
    "newyears.banner.perPerson": "por pessoa",
    "newyears.banner.includes": "Refeição de Quatro Pratos + Uma Bebida Não Alcoólica",
    "newyears.banner.date": "31 Dez, 2025",
    "newyears.banner.fourCourses": "4 Pratos",
    "newyears.banner.viewMenu": "Ver Menu e Reservar",
    "newyears.banner.call": "Ligar",
    "newyears.banner.reserve": "Reservar",
    "newyears.banner.limited": "Lugares limitados disponíveis. Reserve cedo!",
  },
  ar: {
    // Navigation
    "nav.home": "الرئيسية",
    ...
    // New Year's Eve Page
    "newyears.hero.year": "2026",
    "newyears.hero.title": "ليلة رأس السنة",
    "newyears.hero.restaurant": "مطعم تورمريك",
    "newyears.hero.subtitle": "باقة عشاء حصرية",
    "newyears.hero.price": "49€",
    "newyears.hero.perPerson": "للشخص الواحد",
    "newyears.hero.includes": "أربعة أطباق + مشروب واحد (غير كحولي)",
    "newyears.btn.reserve": "احجز طاولتك",
    "newyears.btn.backToSite": "العودة للموقع الرئيسي",
    "newyears.menu.badge": "قائمة حصرية",
    "newyears.menu.title": "عشاء ليلة رأس السنة",
    "newyears.menu.subtitle": "تجربة أربعة أطباق منتقاة بعناية تضم أفضل المأكولات الباكستانية والهندية",
    "newyears.menu.appetizers": "المقبلات",
    "newyears.menu.starters": "الأطباق الأولى",
    "newyears.menu.mainCourse": "الطبق الرئيسي",
    "newyears.menu.sweets": "الحلويات",
    "newyears.menu.drinks": "المشروبات",
    "newyears.menu.papadum": "بابادوم",
    "newyears.menu.papadumDesc": "رقائق العدس الرقيقة والمقرمشة، متبلة بشكل مثالي وتقدم مع صلصات الشاتني المنزلية الخاصة.",
    "newyears.menu.kebab": "كباب تورمريك الخاص",
    "newyears.menu.kebabDesc": "مزيج رائع من الكباب غير النباتي الطري والكباب النباتي اللذيذ، مشوي بشكل مثالي ويقدم مع صلصة النعناع وصلصة التمر الهندي والرايتا المتبلة.",
    "newyears.menu.curry": "كاري واحد من اختيارك من مجموعتنا المميزة",
    "newyears.menu.curryDesc": "باتر تشيكن، تشيكن تيكا ماسالا، كاري/كاداي الدجاج، كاداي/كاري اللحم البقري، كورما اللحم البقري، بالاك بانير، بانير باتر ماسالا، كورما الخضار ودال تادكا/مخني.",
    "newyears.menu.naan": "خبز النان من اختيارك مع الأرز المطهو على البخار",
    "newyears.menu.kheer": "خير",
    "newyears.menu.kheerDesc": "بودينغ الأرز الكريمي مع الهيل ورشة من المكسرات لنهاية فاخرة.",
    "newyears.menu.halwa": "حلوى الجزر",
    "newyears.menu.halwaDesc": "حلوى جزر دافئة وغنية مطبوخة في الحليب والهيل، مغطاة بالمكسرات المقرمشة.",
    "newyears.menu.rasmalai": "راس ملاي",
    "newyears.menu.rasmalaiDesc": "بانير كريمي ناعم منقوع في حليب الزعفران، محلى بدقة ومزين بالفستق.",
    "newyears.menu.lassi": "لاسي منزلي خاص (مانجو، حلو أو مالح) أو مشروب غازي / ماء",
    "newyears.menu.completePackage": "الباقة الكاملة:",
    "newyears.gallery.title": "طعم ما ينتظرك",
    "newyears.gallery.subtitle": "استمتع بأفضل المأكولات الباكستانية والهندية، محضرة بحب وتوابل أصيلة",
    "newyears.reservation.title": "احجز طاولتك",
    "newyears.reservation.subtitle": "احجز مكانك لاحتفال لا يُنسى بليلة رأس السنة",
    "newyears.reservation.cardTitle": "حجز ليلة رأس السنة",
    "newyears.reservation.cardSubtitle": "31 ديسمبر 2025 - احتفل معنا!",
    "newyears.form.fullName": "الاسم الكامل *",
    "newyears.form.namePlaceholder": "اسمك",
    "newyears.form.email": "البريد الإلكتروني *",
    "newyears.form.emailPlaceholder": "بريدك@الإلكتروني.com",
    "newyears.form.phone": "رقم الهاتف *",
    "newyears.form.phonePlaceholder": "رقم الهاتف",
    "newyears.form.guests": "عدد الضيوف *",
    "newyears.form.selectGuests": "اختر عدد الضيوف",
    "newyears.form.guest": "ضيف",
    "newyears.form.guests_plural": "ضيوف",
    "newyears.form.specialRequests": "طلبات خاصة",
    "newyears.form.specialRequestsPlaceholder": "أي متطلبات غذائية أو طلبات خاصة...",
    "newyears.form.submit": "إرسال طلب الحجز",
    "newyears.form.confirmNote": "سنؤكد حجزك خلال 48 ساعة",
    "newyears.form.searchCountry": "بحث...",
    "newyears.success.title": "تم إرسال طلب الحجز!",
    "newyears.success.message": "شكراً لاختيارك مطعم تورمريك لاحتفالك بليلة رأس السنة.",
    "newyears.success.confirmNote": "سنتواصل معك خلال 48 ساعة لتأكيد حجزك.",
    "newyears.success.anotherReservation": "إجراء حجز آخر",
    "newyears.contact.title": "تواصل معنا مباشرة",
    "newyears.contact.callUs": "اتصل بنا",
    "newyears.contact.emailUs": "راسلنا",
    "newyears.contact.visitUs": "زرنا",
    "newyears.eventDetails.title": "تفاصيل الحدث",
    "newyears.eventDetails.date": "31 ديسمبر 2025",
    "newyears.eventDetails.courses": "عشاء من أربعة أطباق",
    "newyears.eventDetails.drink": "مشروب غير كحولي واحد مشمول",
    "newyears.eventDetails.note": "تورمريك مطعم خالٍ من الكحول. نقدم مجموعة متنوعة من اللاسي المنزلي والمشروبات الغازية والمشروبات المنعشة.",
    "newyears.footer.copyright": "© 2025 مطعم تورمريك. جميع الحقوق محفوظة.",
    "newyears.footer.backToMain": "العودة للموقع الرئيسي",
    "newyears.banner.title": "عشاء ليلة رأس السنة 2026",
    "newyears.banner.courses": "4 أطباق + مشروب",
    "newyears.banner.reserveNow": "احجز الآن",
    "newyears.banner.book": "احجز",
    "newyears.banner.dinnerPackage": "باقة العشاء",
    "newyears.banner.perPerson": "للشخص",
    "newyears.banner.includes": "وجبة من أربعة أطباق + مشروب غير كحولي",
    "newyears.banner.date": "31 ديسمبر 2025",
    "newyears.banner.fourCourses": "4 أطباق",
    "newyears.banner.viewMenu": "عرض القائمة والحجز",
    "newyears.banner.call": "اتصل",
    "newyears.banner.reserve": "احجز",
    "newyears.banner.limited": "مقاعد محدودة متاحة. احجز مبكراً!",
  },
  fr: {
    // Navigation
    "nav.home": "Accueil",
    ...
    // New Year's Eve Page
    "newyears.hero.year": "2026",
    "newyears.hero.title": "RÉVEILLON DU NOUVEL AN",
    "newyears.hero.restaurant": "Restaurant Turmeric",
    "newyears.hero.subtitle": "Forfait Dîner Exclusif",
    "newyears.hero.price": "49€",
    "newyears.hero.perPerson": "par personne",
    "newyears.hero.includes": "Quatre Plats + Une Boisson (Non Alcoolisée)",
    "newyears.btn.reserve": "Réservez Votre Table",
    "newyears.btn.backToSite": "Retour au Site Principal",
    "newyears.menu.badge": "Menu Exclusif",
    "newyears.menu.title": "Dîner du Réveillon",
    "newyears.menu.subtitle": "Une expérience de quatre plats soigneusement sélectionnés mettant en vedette la meilleure cuisine pakistanaise et indienne",
    "newyears.menu.appetizers": "ENTRÉES",
    "newyears.menu.starters": "HORS-D'ŒUVRE",
    "newyears.menu.mainCourse": "PLAT PRINCIPAL",
    "newyears.menu.sweets": "DESSERTS",
    "newyears.menu.drinks": "BOISSONS",
    "newyears.menu.papadum": "Papadum",
    "newyears.menu.papadumDesc": "Gaufrettes de lentilles fines et croustillantes, parfaitement épicées et servies avec des chutneys maison spéciaux.",
    "newyears.menu.kebab": "Kebab Spécial Turmeric",
    "newyears.menu.kebabDesc": "Une délicieuse combinaison de kebabs non végétariens tendres et de kebabs végétariens savoureux, parfaitement grillés et servis avec du chutney à la menthe, de la sauce au tamarin et du raïta épicé.",
    "newyears.menu.curry": "Un Curry de Votre Choix de Notre Collection Signature",
    "newyears.menu.curryDesc": "Butter Chicken, Chicken Tikka Masala, Chicken Curry/Kadhai, Beef Kadhai/Curry, Beef Korma, Palak Paneer, Paneer Butter Masala, Vegetable Korma et Daal Tadka/Makhni.",
    "newyears.menu.naan": "Pain Naan de Votre Choix et Riz Vapeur",
    "newyears.menu.kheer": "Kheer",
    "newyears.menu.kheerDesc": "Pudding de riz crémeux à la cardamome, avec une pincée de noix pour une finition luxueuse.",
    "newyears.menu.halwa": "Gajjar Halwa",
    "newyears.menu.halwaDesc": "Dessert chaud et riche aux carottes cuit dans du lait et de la cardamome, garni de noix croquantes.",
    "newyears.menu.rasmalai": "Rasmalai",
    "newyears.menu.rasmalaiDesc": "Paneer crémeux doux trempé dans du lait au safran, délicatement sucré et garni de pistaches.",
    "newyears.menu.lassi": "Lassi Spécial Maison (Mangue, Sucré ou Salé) ou Boisson Gazeuse / Eau",
    "newyears.menu.completePackage": "Forfait Complet:",
    "newyears.gallery.title": "Un Avant-Goût de Ce Qui Vous Attend",
    "newyears.gallery.subtitle": "Découvrez la meilleure cuisine pakistanaise et indienne, préparée avec amour et épices authentiques",
    "newyears.reservation.title": "Réservez Votre Table",
    "newyears.reservation.subtitle": "Assurez votre place pour une célébration inoubliable du Réveillon",
    "newyears.reservation.cardTitle": "Réservation du Réveillon",
    "newyears.reservation.cardSubtitle": "31 Décembre 2025 - Célébrez avec nous!",
    "newyears.form.fullName": "Nom Complet *",
    "newyears.form.namePlaceholder": "Votre nom",
    "newyears.form.email": "Email *",
    "newyears.form.emailPlaceholder": "votre@email.com",
    "newyears.form.phone": "Numéro de Téléphone *",
    "newyears.form.phonePlaceholder": "Numéro de téléphone",
    "newyears.form.guests": "Nombre d'Invités *",
    "newyears.form.selectGuests": "Sélectionnez le nombre d'invités",
    "newyears.form.guest": "invité",
    "newyears.form.guests_plural": "invités",
    "newyears.form.specialRequests": "Demandes Spéciales",
    "newyears.form.specialRequestsPlaceholder": "Toute exigence alimentaire ou demande spéciale...",
    "newyears.form.submit": "Soumettre la Demande de Réservation",
    "newyears.form.confirmNote": "Nous confirmerons votre réservation dans les 48 heures",
    "newyears.form.searchCountry": "Rechercher...",
    "newyears.success.title": "Demande de Réservation Soumise!",
    "newyears.success.message": "Merci d'avoir choisi le Restaurant Turmeric pour votre célébration du Réveillon.",
    "newyears.success.confirmNote": "Nous vous contacterons dans les 48 heures pour confirmer votre réservation.",
    "newyears.success.anotherReservation": "Faire Une Autre Réservation",
    "newyears.contact.title": "Contactez-Nous Directement",
    "newyears.contact.callUs": "Appelez-nous",
    "newyears.contact.emailUs": "Envoyez-nous un email",
    "newyears.contact.visitUs": "Visitez-nous",
    "newyears.eventDetails.title": "Détails de l'Événement",
    "newyears.eventDetails.date": "31 Décembre 2025",
    "newyears.eventDetails.courses": "Dîner Quatre Plats",
    "newyears.eventDetails.drink": "Une Boisson Non Alcoolisée Incluse",
    "newyears.eventDetails.note": "Turmeric est un restaurant sans alcool. Nous proposons une variété de lassis maison, boissons gazeuses et rafraîchissements.",
    "newyears.footer.copyright": "© 2025 Restaurant Turmeric. Tous droits réservés.",
    "newyears.footer.backToMain": "Retour au Site Principal",
    "newyears.banner.title": "Dîner du Réveillon 2026",
    "newyears.banner.courses": "4 Plats + Boisson",
    "newyears.banner.reserveNow": "Réservez Maintenant",
    "newyears.banner.book": "Réserver",
    "newyears.banner.dinnerPackage": "Forfait Dîner",
    "newyears.banner.perPerson": "par personne",
    "newyears.banner.includes": "Repas Quatre Plats + Une Boisson Non Alcoolisée",
    "newyears.banner.date": "31 Déc. 2025",
    "newyears.banner.fourCourses": "4 Plats",
    "newyears.banner.viewMenu": "Voir le Menu et Réserver",
    "newyears.banner.call": "Appeler",
    "newyears.banner.reserve": "Réserver",
    "newyears.banner.limited": "Places limitées disponibles. Réservez tôt!",
  },
  es: {
    // Navigation
    "nav.home": "Inicio",
    ...
    // New Year's Eve Page
    "newyears.hero.year": "2026",
    "newyears.hero.title": "NOCHEVIEJA",
    "newyears.hero.restaurant": "Restaurante Turmeric",
    "newyears.hero.subtitle": "Paquete de Cena Exclusivo",
    "newyears.hero.price": "49€",
    "newyears.hero.perPerson": "por persona",
    "newyears.hero.includes": "Cuatro Platos + Una Bebida (Sin Alcohol)",
    "newyears.btn.reserve": "Reserve Su Mesa",
    "newyears.btn.backToSite": "Volver al Sitio Principal",
    "newyears.menu.badge": "Menú Exclusivo",
    "newyears.menu.title": "Cena de Nochevieja",
    "newyears.menu.subtitle": "Una experiencia de cuatro platos cuidadosamente seleccionados con la mejor cocina pakistaní e india",
    "newyears.menu.appetizers": "APERITIVOS",
    "newyears.menu.starters": "ENTRANTES",
    "newyears.menu.mainCourse": "PLATO PRINCIPAL",
    "newyears.menu.sweets": "POSTRES",
    "newyears.menu.drinks": "BEBIDAS",
    "newyears.menu.papadum": "Papadum",
    "newyears.menu.papadumDesc": "Obleas finas y crujientes de lentejas, perfectamente especiadas y servidas con chutneys caseros especiales.",
    "newyears.menu.kebab": "Kebab Especial Turmeric",
    "newyears.menu.kebabDesc": "Una deliciosa combinación de kebabs tiernos no vegetarianos y sabrosos kebabs vegetarianos, perfectamente asados y servidos con chutney de menta, salsa de tamarindo y raita especiada.",
    "newyears.menu.curry": "Un Curry de Su Elección de Nuestra Colección Especial",
    "newyears.menu.curryDesc": "Butter Chicken, Chicken Tikka Masala, Chicken Curry/Kadhai, Beef Kadhai/Curry, Beef Korma, Palak Paneer, Paneer Butter Masala, Vegetable Korma y Daal Tadka/Makhni.",
    "newyears.menu.naan": "Pan Naan de Su Elección y Arroz al Vapor",
    "newyears.menu.kheer": "Kheer",
    "newyears.menu.kheerDesc": "Pudín de arroz cremoso con cardamomo y una pizca de frutos secos para un final lujoso.",
    "newyears.menu.halwa": "Gajjar Halwa",
    "newyears.menu.halwaDesc": "Postre caliente y rico de zanahoria cocido en leche y cardamomo, cubierto con frutos secos crujientes.",
    "newyears.menu.rasmalai": "Rasmalai",
    "newyears.menu.rasmalaiDesc": "Paneer cremoso suave empapado en leche con azafrán, delicadamente endulzado y decorado con pistachos.",
    "newyears.menu.lassi": "Lassi Especial Casero (Mango, Dulce o Salado) o Refresco / Agua",
    "newyears.menu.completePackage": "Paquete Completo:",
    "newyears.gallery.title": "Un Sabor de Lo Que Le Espera",
    "newyears.gallery.subtitle": "Experimente la mejor cocina pakistaní e india, preparada con amor y especias auténticas",
    "newyears.reservation.title": "Reserve Su Mesa",
    "newyears.reservation.subtitle": "Asegure su lugar para una celebración inolvidable de Nochevieja",
    "newyears.reservation.cardTitle": "Reserva de Nochevieja",
    "newyears.reservation.cardSubtitle": "31 de Diciembre de 2025 - ¡Celebre con nosotros!",
    "newyears.form.fullName": "Nombre Completo *",
    "newyears.form.namePlaceholder": "Su nombre",
    "newyears.form.email": "Email *",
    "newyears.form.emailPlaceholder": "su@email.com",
    "newyears.form.phone": "Número de Teléfono *",
    "newyears.form.phonePlaceholder": "Número de teléfono",
    "newyears.form.guests": "Número de Invitados *",
    "newyears.form.selectGuests": "Seleccione el número de invitados",
    "newyears.form.guest": "invitado",
    "newyears.form.guests_plural": "invitados",
    "newyears.form.specialRequests": "Solicitudes Especiales",
    "newyears.form.specialRequestsPlaceholder": "Cualquier requisito dietético o solicitud especial...",
    "newyears.form.submit": "Enviar Solicitud de Reserva",
    "newyears.form.confirmNote": "Confirmaremos su reserva en 48 horas",
    "newyears.form.searchCountry": "Buscar...",
    "newyears.success.title": "¡Solicitud de Reserva Enviada!",
    "newyears.success.message": "Gracias por elegir el Restaurante Turmeric para su celebración de Nochevieja.",
    "newyears.success.confirmNote": "Le contactaremos en 48 horas para confirmar su reserva.",
    "newyears.success.anotherReservation": "Hacer Otra Reserva",
    "newyears.contact.title": "Contáctenos Directamente",
    "newyears.contact.callUs": "Llámenos",
    "newyears.contact.emailUs": "Envíenos un email",
    "newyears.contact.visitUs": "Visítenos",
    "newyears.eventDetails.title": "Detalles del Evento",
    "newyears.eventDetails.date": "31 de Diciembre de 2025",
    "newyears.eventDetails.courses": "Cena de Cuatro Platos",
    "newyears.eventDetails.drink": "Una Bebida Sin Alcohol Incluida",
    "newyears.eventDetails.note": "Turmeric es un restaurante sin alcohol. Ofrecemos una variedad de lassis caseros, refrescos y bebidas refrescantes.",
    "newyears.footer.copyright": "© 2025 Restaurante Turmeric. Todos los derechos reservados.",
    "newyears.footer.backToMain": "Volver al Sitio Principal",
    "newyears.banner.title": "Cena de Nochevieja 2026",
    "newyears.banner.courses": "4 Platos + Bebida",
    "newyears.banner.reserveNow": "Reserve Ahora",
    "newyears.banner.book": "Reservar",
    "newyears.banner.dinnerPackage": "Paquete de Cena",
    "newyears.banner.perPerson": "por persona",
    "newyears.banner.includes": "Comida de Cuatro Platos + Una Bebida Sin Alcohol",
    "newyears.banner.date": "31 Dic, 2025",
    "newyears.banner.fourCourses": "4 Platos",
    "newyears.banner.viewMenu": "Ver Menú y Reservar",
    "newyears.banner.call": "Llamar",
    "newyears.banner.reserve": "Reservar",
    "newyears.banner.limited": "¡Plazas limitadas disponibles. Reserve pronto!",
  },
};
