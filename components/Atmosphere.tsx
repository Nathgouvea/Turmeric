              ...
              <Card className="h-full group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg bg-white/90 backdrop-blur-sm relative overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-5">
                  <svg className="w-full h-full" viewBox="0 0 100 100">
                    ...
                    />
                    <circle cx="20" cy="45" r="2" className="text-green-600" fill="currentColor" />
                    <circle cx="80" cy="55" r="1.5" className="text-green-600" fill="currentColor" />
                  </svg>
                </div>
          ...
          <Card className="max-w-4xl mx-auto border-0 shadow-xl bg-gradient-to-r from-green-50 via-white to-primary-gold/10 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              <svg className="w-full h-full" viewBox="0 0 400 200">
                ...
                <ellipse cx="50" cy="75" rx="8" ry="12" transform="rotate(-30 50 75)" className="text-green-600" fill="currentColor" />
                <ellipse cx="150" cy="125" rx="6" ry="10" transform="rotate(20 150 125)" className="text-green-600" fill="currentColor" />
                <ellipse cx="250" cy="75" rx="7" ry="11" transform="rotate(-10 250 75)" className="text-green-600" fill="currentColor" />
                <ellipse cx="350" cy="125" rx="8" ry="12" transform="rotate(40 350 125)" className="text-green-600" fill="currentColor" />
              </svg>
            </div>
            ...
            <CardContent className="p-12 relative">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-3xl font-semibold text-gray-800">{t('atmosphere.highlight.title')}</h3>
              ...
              <div className="flex items-center justify-center mt-8 space-x-6">
                <div className="text-center">
                  <div className="text-2xl font-semibold text-primary-gold">5+</div>
                  <div className="text-sm text-gray-600">{t('atmosphere.stats.years')}</div>
                </div>
                <div className="w-px h-12 bg-gray-300"></div>
                <div className="text-center">
                  <div className="text-2xl font-semibold text-primary-gold">1000+</div>
                  <div className="text-sm text-gray-600">{t('atmosphere.stats.customers')}</div>
                </div>
                <div className="w-px h-12 bg-gray-300"></div>
                <div className="text-center">
                  <div className="text-2xl font-semibold text-primary-gold">100%</div>
                  <div className="text-sm text-gray-600">{t('atmosphere.stats.halal')}</div>
                </div>
              </div>
            </CardContent>
          </Card>
