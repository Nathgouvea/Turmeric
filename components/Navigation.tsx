...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { name: t('nav.gallery'), action: () => { navigateTo('home'); setTimeout(() => scrollToSection('#gallery'), 100) } },
    { name: t('nav.menu'), action: () => { navigateTo('home'); setTimeout(() => scrollToSection('#menu'), 100) } },
    { name: t('nav.about'), action: () => { navigateTo('home'); setTimeout(() => scrollToSection('#about'), 100) } },
    { name: t('nav.reservations'), action: () => navigateTo('reservations') },
    { name: t('nav.contact'), action: () => { navigateTo('home'); setTimeout(() => scrollToSection('#contact'), 100) } },
  ]
