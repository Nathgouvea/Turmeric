...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-white via-green-50/20 to-accent relative overflow-hidden">
      {/* Botanical Decorations */}
      <BotanicalDecor position="top-left" size="lg" className="opacity-8" />
      <BotanicalDecor position="bottom-right" size="md" className="opacity-10" />
              ...
              <Card className="h-full group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg bg-white/90 backdrop-blur-sm relative overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-5">
                  <svg className="w-full h-full" viewBox="0 0 100 100">
                    ...
                    />
                    <ellipse cx="30" cy="75" rx="3" ry="5" transform="rotate(-20 30 75)" className="text-primary-gold" fill="currentColor" />
                    <ellipse cx="70" cy="85" rx="2" ry="4" transform="rotate(30 70 85)" className="text-primary-gold" fill="currentColor" />
                  </svg>
                </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex items-start space-x-4 text-left">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('about.why.recipe.title')}</h4>
                <p className="text-gray-600 text-sm">{t('about.why.recipe.desc')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-4 text-left">
              <CheckCircle className="w-6 h-6 text-primary-gold flex-shrink-0 mt-1" />
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('about.why.ingredients.title')}</h4>
                <p className="text-gray-600 text-sm">{t('about.why.ingredients.desc')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-4 text-left">
              <CheckCircle className="w-6 h-6 text-primary-gold flex-shrink-0 mt-1" />
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">{t('about.why.ambiance.title')}</h4>
                <p className="text-gray-600 text-sm">{t('about.why.ambiance.desc')}</p>
              </div>
            </div>
          </div>
        </motion.div>
